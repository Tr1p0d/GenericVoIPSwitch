...
\section{H.323\cite{h323standard}}
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.3]{fig/core_design}
...
\begin{tabular}{|r|c|c|}
  \hline
 use case & SIP to SIP & SIP to LCPCPv1  \\ \hline
...
\begin{tabular}{|c|c|c|}
  \hline
  header field name & example value & description  \\ \hline
...
\begin{tabular}{|r|l|}
  \hline
  generic message type & meaning \\ \hline
